...
//  JamAppPractice
//
//  Created by Patrick O'Leary on 4/2/17.
...
class MultipeerManager: NSObject {
    ...
    func send(sequence: [String: [Bool]]) {
        
        let json = try? JSONSerialization.data(withJSONObject: sequence, options: [])
